# Komendantov et al. (2004) Model Readme
...
- If you want a graphical user interface, set `back = 0` in `damodel.hoc`, then type:
...
- To run simulations in the background set `back = 1` and run:
